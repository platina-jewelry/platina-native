...
- **Redux + Redux Toolkit:**  
  ...
  **Redux Thunk:**  — это Middleware для Redux, который позволяет писать асинхронные логики внутри экшенов. Redux Thunk
  упрощает работу с асинхронными операциями, такими как запросы к API, и позволяет диспетчить экшены после завершения
  операций.
...
- **Sentry:** Sentry — это сервис для мониторинга ошибок и отслеживания их в реальном времени. С его помощью мы можем
...
- **React Native Performance Monitor:** Этот встроенный инструмент React Native помогает отслеживать производительность
